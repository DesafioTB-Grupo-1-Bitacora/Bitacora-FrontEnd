		...
		<MapComponent/>
			...
			<Wrapper onSubmit={handleSubmit(onSubmit)}>
				...
				<BoxSetBasicData>
					...
					<BoxFirstBtns>
					<NotebookTitle placeholder="Titulo del cuaderno" type= "text" minLength="3" maxLength="20" size="16"/>
					<DateOpt
						type="date"
						size="10"

					/>
					<Ubication type="text" placeholder='Ubicación'minLength="3" maxLength="20" size="11"/>
				</BoxFirstBtns>
					</Box1>
	<Box2>
