...
const Memory = () => {
    ...
    const imageAndVideo = memory?.multimedia.filter(file => file.tag === "image" || file.tag === "video") || null;
    const audios = memory?.multimedia.filter(file => file.tag === "audio") || null;
    ...
    return (
        <>
            ...
            <Styled.Container>
                ...
                {audios && audios.map(audio => <Styled.Audio src={audio.url} controls={true} />)}
                <Styled.MediaBox>
                    <Styled.Box>
                        <Styled.Logo>
