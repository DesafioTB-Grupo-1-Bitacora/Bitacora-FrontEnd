...
gap: 32px;
flex-shrink: 0;
background: var(--blanco, #F5F5FA);
`

const BloqueSuperior = styled.div`
display: flex;
height: 101px;
flex-direction: column;
align-items: center;
...
align-items: center;
border-radius: 10px;
background: var(--gris-oscuro, #616163);
color: White;
`
...
<svg xmlns="http://www.w3.org/2000/svg" width="73" height="4" viewBox="0 0 73 4" fill="none">
  <path d="M1.5 2H71.5" stroke="#0C0C0F" stroke-width="3" stroke-linecap="round"/>
</svg>
			</Funcionality>
