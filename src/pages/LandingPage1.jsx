  ...
  return (
    <>
      ...
      <StyledWrapper>
        <FuncionalitiesIcons>
          <IconsAndDEscription>
            ...
            <Funcionality href={`/#entusviajes`}>
              ...
              >
                <path
                  d="M13.1668 25H4.50016C3.79292 25 3.11464 24.719 2.61454 24.219C2.11445 23.7189 1.8335 23.0406 1.8335 22.3333V6.33333C1.8335 5.62609 2.11445 4.94781 2.61454 4.44772C3.11464 3.94762 3.79292 3.66667 4.50016 3.66667H20.5002C21.2074 3.66667 21.8857 3.94762 22.3858 4.44772C22.8859 4.94781 23.1668 5.62609 23.1668 6.33333V11.6667M17.8335 1V6.33333"
                  stroke="#0C0C0F"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M21.8335 21V21.0133M7.16683 1V6.33333M1.8335 11.6667H23.1668M24.6615 23.828C25.221 23.2686 25.6021 22.5559 25.7565 21.78C25.911 21.004 25.8318 20.1997 25.5291 19.4687C25.2264 18.7377 24.7137 18.1129 24.0559 17.6734C23.3981 17.2338 22.6247 16.9991 21.8335 16.9991C21.0423 16.9991 20.2689 17.2338 19.6111 17.6734C18.9533 18.1129 18.4406 18.7377 18.1379 19.4687C17.8351 20.1997 17.756 21.004 17.9104 21.78C18.0649 22.5559 18.446 23.2686 19.0055 23.828C19.5628 24.3867 20.5055 25.2213 21.8335 26.3333C23.2348 25.1467 24.1788 24.312 24.6615 23.828Z"
                  stroke="#0C0C0F"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <Funcionality href={`/#miracambia`}>
              ...
              >
                <path
                  d="M16.167 25.3334C14.3428 24.2801 12.2734 23.7257 10.167 23.7257C8.06055 23.7257 5.99122 24.2801 4.16699 25.3334V8.00003C5.99122 6.94681 8.06055 6.39233 10.167 6.39233C12.2734 6.39233 14.3428 6.94681 16.167 8.00003V25.3334ZM16.167 25.3334C17.9912 24.2801 20.0606 23.7257 22.167 23.7257C24.2734 23.7257 26.3428 24.2801 28.167 25.3334V12"
                  stroke="#0C0C0F"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M22.8335 6.6676V6.68094M25.6615 9.4956C26.221 8.93624 26.6021 8.22351 26.7566 7.44755C26.911 6.6716 26.8318 5.86727 26.5291 5.13629C26.2264 4.40532 25.7137 3.78053 25.0559 3.34095C24.3981 2.90137 23.6247 2.66675 22.8335 2.66675C22.0423 2.66675 21.2689 2.90137 20.6111 3.34095C19.9533 3.78053 19.4406 4.40532 19.1379 5.13629C18.8351 5.86727 18.756 6.6716 18.9104 7.44755C19.0649 8.22351 19.446 8.93624 20.0055 9.4956C20.5628 10.0543 21.5055 10.8889 22.8335 12.0009C24.2348 10.8143 25.1788 9.9796 25.6615 9.4956Z"
                  stroke="#0C0C0F"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <ExplanationSubtitle>
          Lo mejor de Tripmemories es dar rienda suelta a tus emociones y
        ...
        <ComenzarRegistro>
          ...
          <SubtitleRegistro>
            Centrarse en plasmar las experiencias de los viajes. Revivirlas
            siempre que quieras{" "}
          </SubtitleRegistro>
          <Link to={"/register"}>
